...
export default function JewelryProductDetails() {
  const { id } = useParams();
  ...
  return (
    <div className="w-full bg-white pt-10 px-4 md:px-8 lg:px-12 flex flex-col lg:flex-row gap-6">
      ...
      <div className="w-full lg:w-1/2 flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-1">
          <button
            className="w-full text-[18px] leading-[26px] font-playfair
             bg-white cursor-pointer py-2 border text-[#030303] border-[#030303] hover:border-[#419338] hover:text-[#419338] transition-all duration-150"
            onClick={() => {
              addToCart(product);
              openCart();
            }}
